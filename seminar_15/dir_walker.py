...
FSObject = namedtuple('FSObject', 'name ext is_dir parent')   # (имя файла, расширение, директория или нет, родительская директория) - кортеж
...
def walk_dir(path_string: str):
    ...
    parent = path_string.rsplit('/', 1)[1]          # получаем абсолютный путь
    try:
